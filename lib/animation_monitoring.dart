...
class AnimationMonitoring extends StatefulWidget {
  final bool isRunning;

  const AnimationMonitoring({Key? key, required this.isRunning}) : super(key: key);

  @override
  _AnimationMonitoringState createState() => _AnimationMonitoringState();
}

class _AnimationMonitoringState extends State<AnimationMonitoring> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant AnimationMonitoring oldWidget) {
